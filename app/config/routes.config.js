...
export const ROUTES = {
  ...
  DASHBOARD: {
    ...
    SCHEDULE: {
      ...
      isPublic: false,
      allowedRoles: [AccountType.TRAINER, AccountType.TRAINEE],
      meta: { title: 'Schedule - NetQwix' },
    },
    BOOK_LESSON: {
      path: '/dashboard/book-lesson',
      name: 'Book Lesson',
      requiresAuth: true,
      isPublic: false,
      allowedRoles: [AccountType.TRAINEE],
      meta: { title: 'Book Expert - NetQwix' },
    },
    CHATS: {
    ...
    UPCOMING_SESSIONS: {
      ...
      isPublic: false,
      allowedRoles: [AccountType.TRAINER, AccountType.TRAINEE],
      meta: { title: 'Upcoming Sessions - NetQwix' },
    },
    MY_COMMUNITY: {
      ...
      isPublic: false,
      allowedRoles: [AccountType.TRAINER, AccountType.TRAINEE],
      meta: { title: 'My Community - NetQwix' },
    },
    CONTACT_US: {
    ...
    MEETING_ROOM: {
      ...
      isPublic: false,
      allowedRoles: [AccountType.TRAINER, AccountType.TRAINEE],
      meta: { title: 'Meeting Room - NetQwix' },
    },
    PRACTICE_SESSION: {
      path: '/dashboard/practice-session',
      name: 'Practice Session',
      requiresAuth: true,
      isPublic: false,
      allowedRoles: [AccountType.TRAINER, AccountType.TRAINEE],
      meta: { title: 'Practice Session - NetQwix' },
    },
  },
