                    ...
                    <>
                        ...
                        <div className="container px-0" style={{ maxWidth: "100%", margin: "0 auto" }}>
                            <div className="row gx-2" style={{ 
                                ...
                                <h4 className="col-6 ps-0" style={{ margin: 0, fontSize: "0.8125rem", fontWeight: 600, lineHeight: 1.35 }}>{"How would you rate your expert?"}</h4>
                            ...
                            <div className="row gx-2 mt-1 mb-1" style={{ 
                                ...
                                <h4 className="col-6 ps-0" style={{ margin: 0, fontSize: "0.8125rem", fontWeight: 600, lineHeight: 1.35 }}> {"Please rate your audio/video connection?"} </h4>
                                <div className="col" style={{ display: "flex", justifyContent: "flex-end" }}>
                                    <ColoredRating
                            ...
                            {accountType === AccountType.TRAINER ? (
                                ...
                                <>
                                    <div className="row gx-2 mt-1 mb-1" style={{ 
                                        ...
                                        <h4 className="col-6 ps-0" style={{ margin: 0, fontSize: "0.8125rem", fontWeight: 600, lineHeight: 1.32 }}>
